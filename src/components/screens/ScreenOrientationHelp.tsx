...
const ScreenOrientationHelp: React.FC<{ onNavigate: (id: string) => void }> = ({ onNavigate }) => (
  <div className="space-y-4">
    <div className="px-1">
      <h2 className="transit-hero-text">Orientation help</h2>
      <p className="text-sm text-muted-foreground mt-1">Use these cues to find where you are</p>
    </div>

    <div className="transit-card space-y-0">
      <div className="transit-info-row">
        <div className="transit-info-icon"><BookOpen className="w-5 h-5" /></div>
        <div>
          <p className="text-base font-semibold">Building directory</p>
          <p className="text-xs text-muted-foreground">Located in main lobby - lists all rooms by floor</p>
        </div>
      </div>
      <div className="transit-info-row">
        <div className="transit-info-icon"><Hash className="w-5 h-5" /></div>
        <div>
          <p className="text-base font-semibold">Room number pattern</p>
      ...
      <div className="transit-info-row">
        <div className="transit-info-icon"><Signpost className="w-5 h-5" /></div>
        <div>
          <p className="text-base font-semibold">Floor signs</p>
